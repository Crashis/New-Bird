...
(function (NWI18n) {
  ...
  const translations = {
    cs: {
      ...
      'menu.pets': '🐾 Pets',
      'bottom.petsHint': 'Mazlíčci (WIP)',
      'pets.title': '🐾 Pets',
      'pets.subtitle': 'Mazlíčci jsou ve vývoji. Bonusy budou doplněné později — zatím si jen vyber svého oblíbence.',
      'pets.close': '✕ Zavřít',
      'pets.select': 'Vybrat',
      'pets.deselect': 'Zrušit výběr',
      'pets.dog.name': 'Pes',
      'pets.dog.bonus': 'Bonus k yangům — připravuje se',
      'pets.cat.name': 'Kočka',
      'pets.cat.bonus': 'Větší šance na rare odměny — připravuje se',
      'pets.parrot.name': 'Papoušek',
      'pets.parrot.bonus': 'Občasná hláška navíc — připravuje se',
      'pets.hamster.name': 'Křeček',
      ...
      'credits.tester': '🧪 Hlavní tester: Saradyn',
      ...
      'heirloom.rocket.description': 'Klávesou E vystřelíš raketu, která zničí první překážku před tebou.',
      ...
      'godias.easterEgg.line': 'zipuje se, zipuje se',

      'heirloom.reklamace.name': '📝 Reklamační formulář',
      'heirloom.reklamace.description': 'Nevyhrál jsi, ale aspoň sis stěžoval dost nahlas. Po každé prohrané minihře ti vrátí 25 % vkladu (zaokrouhleno).',
      'heirloom.reklamace.price': 'Cena: 888 Yangů · 18 Peněženek · 10 Err kostek',
      'heirloom.reklamace.locked': 'Zamčeno',
      'heirloom.reklamace.unlock': 'Koupit',
      'heirloom.reklamace.purchased': 'Zakoupeno',
      'heirloom.reklamace.unlocked': '📝 Reklamační formulář podán! 25 % cashback z prohraných miniher.',
      'heirloom.reklamace.notEnough': 'Nedostatek měn. Potřebuješ 888 Yangů, 18 Peněženek a 10 Err kostek.',
      'heirloom.reklamace.cashbackTitle': '📝 REKLAMACE UZNÁNA',
      'heirloom.reklamace.cashbackMsg': 'Vráceno: {refund}',
      ...
      'shop.shieldRegen.desc': 'Když přijdeš o štít, Amazon ho po chvíli reklamuje a doručí náhradu. Základní cooldown štítu je 30 s — každý upgrade ho zkrátí, takže se štít obnoví rychleji. Obnoví jen 1 štít na cooldown a nikdy nepřekročí tvoje aktuální maximum (respektuje Druhý štít).',
    ...
    en: {
      ...
      'menu.pets': '🐾 Pets',
      'bottom.petsHint': 'Pets (WIP)',
      'pets.title': '🐾 Pets',
      'pets.subtitle': 'Pets are in development. Bonuses will be added later — for now just pick your favorite.',
      'pets.close': '✕ Close',
      'pets.select': 'Select',
      'pets.deselect': 'Unselect',
      'pets.dog.name': 'Dog',
      'pets.dog.bonus': 'Yang bonus — coming soon',
      'pets.cat.name': 'Cat',
      'pets.cat.bonus': 'Higher chance for rare rewards — coming soon',
      'pets.parrot.name': 'Parrot',
      'pets.parrot.bonus': 'Occasional extra voice line — coming soon',
      'pets.hamster.name': 'Hamster',
      ...
      'credits.tester': '🧪 Lead tester: Saradyn',
      ...
      'heirloom.rocket.description': 'Press E to fire a rocket that destroys the first obstacle ahead.',
      ...
      'godias.easterEgg.line': 'zipping, zipping',

      'heirloom.reklamace.name': '📝 Complaint Form',
      'heirloom.reklamace.description': "You didn't win, but at least you complained loudly enough. After each lost minigame you get back 25% of your stake (rounded).",
      'heirloom.reklamace.price': 'Cost: 888 Yangs · 18 Wallets · 10 Err Cubes',
      'heirloom.reklamace.locked': 'Locked',
      'heirloom.reklamace.unlock': 'Buy',
      'heirloom.reklamace.purchased': 'Purchased',
      'heirloom.reklamace.unlocked': '📝 Complaint filed! 25% cashback on lost minigames.',
      'heirloom.reklamace.notEnough': 'Not enough currency. Need 888 Yangs, 18 Wallets and 10 Err Cubes.',
      'heirloom.reklamace.cashbackTitle': '📝 COMPLAINT ACCEPTED',
      'heirloom.reklamace.cashbackMsg': 'Refunded: {refund}',
      ...
      'shop.shieldRegen.desc': 'Lose a shield and Amazon files a complaint, then ships a replacement. The default shield cooldown is 30s — each upgrade reduces it, so your shield recovers faster. Restores 1 shield per cooldown and never exceeds your current max (respects Second Shield).',
