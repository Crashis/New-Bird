...
(function (NWI18n) {
  ...
  const translations = {
    cs: {
      ...
      'toast.hesoyam.subtitle': '+500 Yangů · +50 Peněženek',
      'cheat.hesoyam.status': 'HESOYAM aktivován: +500 Yangů, +50 Peněženek.',
    ...
    en: {
      ...
      'toast.hesoyam.title': 'HESOYAM',
      'toast.hesoyam.subtitle': '+500 Yangs · +50 Wallets',
      'cheat.hesoyam.status': 'HESOYAM activated: +500 Yangs, +50 Wallets.',
