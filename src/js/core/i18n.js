...
(function (NWI18n) {
  ...
  const translations = {
    cs: {
      ...
      'multiplayer.subtitle': 'Hraj proti kamarádovi v reálném čase. Vytvoř lobby nebo se připoj přes kód.',
    ...
    en: {
      ...
      'multiplayer.title': '🌐 Multiplayer',
      'multiplayer.subtitle': 'Race a friend in real time. Create a lobby or join with a code.',
